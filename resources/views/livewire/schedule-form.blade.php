...
@endphp
        <title> Đặt lịch -  {{ $settings->website }} </title>


        <meta name="description" content="Discover the lifestyle hub Pikleball Factory in Subang SS13. Enjoy future dining and improved court features at this dynamic venue.">
    ...
    <body class="gradient animate--hover-default">
        ...
        <main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
            ...
            <div class="article-template__comment-wrapper background-secondary" style="
    padding: 3rem;
">
    <div id="comments" class="page-width page-width--narrow scroll-trigger animate--slide-in">
        <!-- Comment Form -->
        <form wire:submit.prevent="submitSchedule" class="comment-form" style="margin-top: 2rem;">
            ...
            <div>
                <div class="article-template__comment-fields">
                    <div class="field field--with-error" style="margin-bottom: 1rem;">
                        <input type="text" wire:model="name" id="CommentForm-author" class="field__input" autocomplete="name" value="" aria-required="true" required placeholder="Họ và tên">
                        <label class="field__label" for="CommentForm-author">Họ và tên
                            <span aria-hidden="true">*</span></label>
                    </div>
                    @error('name') <span class="error">{{ $message }}</span> @enderror
                    <div class="field field--with-error" style="margin-bottom: 1rem;">
                        <input type="text" wire:model="phone" id="CommentForm-author" class="field__input" autocomplete="phone" value="" aria-required="true" required placeholder="Số điện thoại">
                        <label class="field__label" for="CommentForm-author">Số điện thoại
                            <span aria-hidden="true">*</span></label>
                    </div>
                ...
                <div class="field field--with-error" style="margin-bottom: 1rem;">
                    <textarea rows="5" wire:model="content" id="CommentForm-body" class="text-area field__input" aria-required="true" required placeholder="Nội dung liên hệ"></textarea>
                    <label class="form__label field__label" for="CommentForm-body">Nội dung
                        <span aria-hidden="true">*</span></label>
                    @error('content') <span class="error">{{ $message }}</span> @enderror
                </div>
            </div>
            <p class="article-template__comment-warning caption">Lưu ý, vui lòng nhập đủ thông tin.</p>
...
<style>
    /* Ensure that placeholder text is visible */
input::placeholder,
textarea::placeholder {
    color: #888 !important; /* Light gray for placeholder text */
    font-style: italic; /* Op   tional: Make it italic for better visual distinction */
}

/* Optional: Add focus styles to maintain visibility when focusing on inputs */
input:focus::placeholder,
textarea:focus::placeholder {
    color: #888 !important; /* Keep the placeholder color consistent */
    font-style: normal; /* Remove italics on focus */
}

/* Optional: Adjust the input and textarea border to give the fields proper space */
input,
textarea {
    padding: 0.8rem;
